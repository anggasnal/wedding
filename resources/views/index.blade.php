...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div id="fh5co-counter" class="fh5co-bg fh5co-counter" style="background-image:url(asset/images/qq.jpg);">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<div class="fh5co-video fh5co-bg" style="background-image: url(asset/images/qq.jpg); ">
	...
	<div id="fh5co-started" class="fh5co-bg" style="background-image:url(asset/images/qq.jpg);">
		<div class="overlay"></div>
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Write your Whishes</h2>
...
<!-- 	<div id="fh5co-started" class="fh5co-bg" style="background-image:url(asset/images/qq.jpg);">
	...
	<!-- // <script src="{{('asset/')}}https://cdnjs.cloudflare.com/ajax/libs/prism/0.0.1/prism.min.js"></script> -->
